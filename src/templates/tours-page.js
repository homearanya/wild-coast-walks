                    ...
                    <div className="adventure-tab clearfix">
                      <ul className="nav nav-tabs navbar-left">
                        <li>
                          <a
                            className="grid-view"
                            href="shop-grid-no-sidebar.html"
                          >
                        ...
                        <li>
                          <a
                            className="list-view"
                            href="shop-grid-with-sidebar.html"
                          >
                            Shop Grid Sidebar
                          </a>
                        </li>
            ...
            <div className="single-adventure">
              ...
              <div className="adventure-text effect-bottom">
                <div className="transparent-overlay">
                  <h4>
                    <a href="#">
                      Adventure Trip | <span>Europe</span>
                    </a>
                  </h4>
                  <span className="trip-time">
                    <i className="fa fa-clock-o" />5 Day Trip
                  </span>
                  <span className="trip-level">
                    <i className="fa fa-send-o" />Level: Basic
                  </span>
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut
                    ornare ut est in molestie. Vestibulum convallis congue
                    velit, et facilisis lorem efficitur et. Morbi vitae
                    pellentesque nulla.{" "}
                  </p>
                </div>
            ...
            <div className="single-adventure">
              ...
              <div className="adventure-text effect-bottom">
                <div className="transparent-overlay">
                  <h4>
                    <a href="#">
                      Refreshment Trip | <span>India</span>
                    </a>
                  </h4>
                  <span className="trip-time">
                    <i className="fa fa-clock-o" />4 Day Trip
                  </span>
                  <span className="trip-level">
                    <i className="fa fa-send-o" />Level: Basic
                  </span>
            ...
            <div className="single-adventure">
              ...
              <div className="adventure-text effect-bottom">
                <div className="transparent-overlay">
                  <h4>
                    <a href="#">
                      Cycling | <span>Nepal</span>
                    </a>
                  </h4>
                  <span className="trip-time">
                    <i className="fa fa-clock-o" />7 Day Trip
                  </span>
                  <span className="trip-level">
                    <i className="fa fa-send-o" />Level: Advance
                  </span>
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut
                    ornare ut est in molestie. Vestibulum convallis congue
            ...
            <div className="single-adventure">
              ...
              <div className="adventure-text effect-bottom">
                <div className="transparent-overlay">
                  <h4>
                    <a href="#">
                      Family Trip | <span>Bangladesh</span>
                    </a>
                  </h4>
                  <span className="trip-time">
                    <i className="fa fa-clock-o" />3 Day Trip
                  </span>
                  <span className="trip-level">
                    <i className="fa fa-send-o" />Level: Basic
                  </span>
            ...
            <div className="single-adventure">
              ...
              <div className="adventure-text effect-bottom">
                <div className="transparent-overlay">
                  <h4>
                    <a href="#">
                      Adventure Trip | <span>Aeoli Islands</span>
                    </a>
                  </h4>
                  <span className="trip-time">
                    <i className="fa fa-clock-o" />10 Day Trip
                  </span>
                  <span className="trip-level">
                    <i className="fa fa-send-o" />Level: Advance
                  </span>
            ...
            <div className="single-adventure">
              ...
              <div className="adventure-text effect-bottom">
                <div className="transparent-overlay">
                  <h4>
                    <a href="#">
                      Arts and Culture | <span>Egypt</span>
                    </a>
                  </h4>
                  <span className="trip-time">
                    <i className="fa fa-clock-o" />6 Day Trip
                  </span>
                  <span className="trip-level">
                    <i className="fa fa-send-o" />Level: Basic
                  </span>
            ...
            <div className="single-adventure">
              ...
              <div className="adventure-text effect-bottom">
                <div className="transparent-overlay">
                  <h4>
                    <a href="#">
                      Adventure | <span>Everest Camp</span>
                    </a>
                  </h4>
                  <span className="trip-time">
                    <i className="fa fa-clock-o" />30 Day Trip
                  </span>
                  <span className="trip-level">
                    <i className="fa fa-send-o" />Level: Advance
                  </span>
            ...
            <div className="single-adventure">
              ...
              <div className="adventure-text effect-bottom">
                <div className="transparent-overlay">
                  <h4>
                    <a href="#">
                      Road Trip | <span>Ireland</span>
                    </a>
                  </h4>
                  <span className="trip-time">
                    <i className="fa fa-clock-o" />15 Day Trip
                  </span>
                  <span className="trip-level">
                    <i className="fa fa-send-o" />Level: Advance
                  </span>
