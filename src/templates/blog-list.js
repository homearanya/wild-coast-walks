            ...
            {enableBlog ? (
              <div>
                  ...
                  <div className="sidebar-widget">
                    ...
                    <div className="single-sidebar-widget country-select">
                      ...
                      <ul className="widget-categories">
                        ...
                        <li>
                          <a href="#">
                            Camping <span>(175)</span>
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            Trekking <span>(25)</span>
                          </a>
                        </li>
                        <li>
                          <a href="#">
                    ...
                    <div className="single-sidebar-widget">
                      ...
                      <div className="single-widget-posts">
                        ...
                        <div className="posts-text">
                          <h4>
                            <a href="#">Himalaia Trip | Europe</a>
                          </h4>
                          <p>
                            <i className="fa fa-clock-o" /> May 27, 2015
                          </p>
                        </div>
                      </div>
                      <div className="single-widget-posts">
                        ...
                        <div className="posts-text">
                          <h4>
                            <a href="#">Himalaia Trip | Nepal</a>
                          </h4>
                          <p>
                            <i className="fa fa-clock-o" /> Aug 09, 2016
                          </p>
                        </div>
                      </div>
                      <div className="single-widget-posts no-margin">
                        ...
                        <div className="posts-text">
                          <h4>
                            <a href="#">Himalaia Trip | China</a>
                          </h4>
                          <p>
                            <i className="fa fa-clock-o" /> Jun 22, 2016
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="single-sidebar-widget icon-bottom tooltip-icons">
                      ...
                      <div className="widget-icon">
                        <span>
                          <a href="#" data-toggle="tooltip" title="Tents">
                            <img alt="" src="img/icon/25.png" />
                          </a>
                        </span>
                        <span>
                          <a href="#" data-toggle="tooltip" title="Hiking">
                            <img alt="" src="img/icon/26.png" />
                          </a>
                        </span>
                        <span>
                          <a href="#" data-toggle="tooltip" title="Cycling">
                            <img alt="" src="img/icon/27.png" />
                          </a>
                        </span>
                        <span>
                          <a href="#" data-toggle="tooltip" title="Beach">
                            <img alt="" src="img/icon/28.png" />
                          </a>
                        </span>
                        <span className="no-margin">
                          <a href="#" data-toggle="tooltip" title="Ship Tour">
                            <img alt="" src="img/icon/29.png" />
                          </a>
                        </span>
                        <span className="no-margin">
                          <a href="#" data-toggle="tooltip" title="Boat Tour">
                            <img alt="" src="img/icon/30.png" />
                          </a>
                        </span>
                        <span className="no-margin">
                          <a href="#" data-toggle="tooltip" title="Water Games">
                            <img alt="" src="img/icon/31.png" />
                          </a>
                        </span>
                        <span className="no-margin">
                          <a href="#" data-toggle="tooltip" title="Jungle">
                            <img alt="" src="img/icon/32.png" />
                          </a>
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="single-blog-post-text">
                    <h4>
                      <a href="blog-details.html">
                        How's the weather? Best times to travel.....
                      </a>
                    </h4>
                ...
                <div className="single-blog-post">
                  <div className="single-blog-post-img">
                    <a href="#">
                      <img src="img/blog/large-2.jpg" alt="" />
                    </a>
                    <div className="date-time">
                ...
                <div className="single-blog-post">
                  <div className="single-blog-post-img">
                    <a href="#">
                      <img src="img/blog/large-3.jpg" alt="" />
                    </a>
                    <div className="date-time">
                ...
                <div className="single-blog-post">
                  <div className="single-blog-post-img">
                    <a href="#">
                      <img src="img/blog/large-4.jpg" alt="" />
                    </a>
                    <div className="date-time">
                  ...
                  <div className="single-blog-post-text">
                    <h4>
                      <a href="blog-details.html">
                        Lorem Ipsum has been the industry's of.....
                      </a>
                    </h4>
                    <div className="author-comments">
                      <span>
